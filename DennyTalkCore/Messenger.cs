...
namespace DennyTalk
{
    public class Messenger
    {
        ...
        public void Initialize()
        {
            ...
            // «агружаю из хранилища список контактов
            ...
            // ќбновл€ю информацию о пользовател€х из списка контактов
            RequestContactInfos();

            // ќтправл€ю пользовател€м из списка контактов свой статус
        ...
        void telegramListener_TelegramReceived(object sender, TelegramReceivedEventArgs e)
        {
            ...
            if (contact != null)
            {
                if (!contact.Address.EqualHostOrIP(e.Address)) // Ёто условие выполн€тес€, когда контакт был найден по GUID.
